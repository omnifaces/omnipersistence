...
/**
 * <p>
 * Mapped superclass for timestamped entity. It extends from {@link BaseEntity} and implements {@link Timestamped}. It specifies two timestamp columns, named
 * "created" and "lastModified". The {@link Id} column needs to be manually taken care of. On pre persist, the both columns will be set to current timestamp. On
